		...
		<div title="基本信息" id="addWin" style="overflow:hidden">
			<div id="tab-tools" style="background-color: #E0ECFF;">
				<!-- <a href="#" class="easyui-linkbutton" plain="true"
					...
					iconCls="icon-gw-modify"
					onclick="forMainSendJSP2('readRange','canView.jsp',-1)">发放范围授权</a> -->
					<!-- <a href="javascript:void(0)" class="easyui-linkbutton" plain="true"
					iconCls="icon-gw-modify"
					...
					<a href="javascript:void(0)" class="easyui-linkbutton" plain="true"
					iconCls="icon-gw-modify"
					onclick="forMainSendJSP2('readRange','selectSendAim.jsp?type=3',3)">发送到岗位</a> -->
				...
				<form class="easyui-form" id="addForm" method="post">
					<table bordercolor='#ECE9D8'>
						...
						<tr style="height: 20px;">
							...
							<td class="black" align="right">制度&nbsp;&nbsp;</td>
					...
					<!-- 	<tr style="height: 20px;">
						...
						<tr style="height: 55px;">
							<td class="black" align="right">拟办意见&nbsp;&nbsp;</td>
								<td class="white" colspan=5 height="55px"><textarea id="fSuggestion" wrap="virtual" style="width:99% ;height:100%"
								name="fSuggestion"></textarea>
								</td>
						</tr>
						<tr style="height: 55px;">
							<td class="black" align="right">处理情况&nbsp;&nbsp;</td>
									<td class="white" colspan=5  height="55px"><textarea  id="fDealSituation" wrap="virtual" style="width:99% ;height:100%"
									name="fDealSituation"></textarea>
							</td>
						</tr>
						<tr style="height: 20px;">
			...
			<div style="margin-top: 30px">
				<!-- <div id="button">
					<br /> <a style="padding-left: 360px;" class="easyui-linkbutton"
						iconcls="icon-ok" onclick="return add()">保存</a>
				</div> -->
				<!-- <div id="readme" style="display: none;padding-left: 360px;">
					<p>后台正在处理请稍后。。。。。。</p>
				</div> -->
