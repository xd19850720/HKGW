...
<script language="javascript" type="text/javascript"
	src="<%=path %>/jsp/js/senddocjs/sendDocument.js"></script>
<script language="javascript" type="text/javascript"
...
<body class="easyui-layout">
	...
	<!-- 	<div id="div_file_search" class="easyui-dialog" title="查询主送或抄送给本部门的公文" -->
	<!-- 		data-options="iconCls:'icon-search'" -->
	<!-- 		style="width: 400px; height: 240px; padding: 10px"> -->
	<!-- 		<br /> <br /> -->
	<!-- 		<table width="350" style="margin-right: 45px;" cellpadding="7"> -->
	<!-- 			<tr> -->
	<!-- 				<td width="110" align="right">文件名：</td> -->
	<!-- 				<td><input type="text" id="txt_file_name_send" -->
	<!-- 					style="width: 200px;" /></td> -->
	<!-- 				<td width="110" align="right">年度：</td>
<!-- 				<td><input type="text" id="txt_file_year" style="width: 125px;" /></td> -->
	-->
	<!-- 			</tr> -->
	<!-- 			<tr> -->
	<!-- 				<td width="110" align="right">承办部门：</td>
<!-- 				<td width="125px"><input type="text" id="txt_file_dept" -->
	<!-- 					style="width: 125px;" /></td> -->
	-->
	<!-- 				<td width="110" align="right">文件字号：</td> -->
	<!-- 				<td><input type="text" id="txt_file_num" style="width: 200px;" /></td> -->
	<!-- 			</tr> -->
	<!-- 		</table> -->
	<!-- 		<br /> <br /> -->
	<!-- 		<center> -->
	<!-- 			<a onclick="do_file_search()" id="btn_search">查询</a> <a href="#" -->
