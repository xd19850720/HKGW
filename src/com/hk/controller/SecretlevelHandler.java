...
public class SecretlevelHandler {

	@Autowired
	@Qualifier("secretlevelService")
	private SecretlevelService secretlevelService;

	@RequestMapping("/getAllSecretlevel")
	public @ResponseBody
	List<Secretlevel> getAllSecretlevel() {
		return secretlevelService.getAll();
	}
}
